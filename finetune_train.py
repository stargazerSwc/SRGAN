...
parser.add_argument('--train_set_foldpath', default='../input/SRGAN-test/train', help='trainsetfoldpath')
parser.add_argument('--val_set_foldpath', default='../input/SRGAN-test/val', help='valsetfoldpath')
parser.add_argument('--pre_Gmodel',default='../input/SRGAN-test/netG_epoch_4_70.pth', help='pretrained Generator')
parser.add_argument('--pre_Dmodel',default='../input/SRGAN-test/netD_epoch_4_70.pth', help='pretrained Discriminator')
